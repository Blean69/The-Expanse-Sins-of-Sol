# The Expanse 0.28 — C-cadence

**Optional comparison only; not the recommended baseline.** Same as B120, except both Donnager heavy guns reload in 24 seconds instead of 30. Unchanged first volley; theoretical sustained throughput rises 25%. Gameplay comparison has NOT RUN. Use only after the A/B checks.
