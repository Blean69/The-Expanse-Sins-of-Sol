# 0.27.2 Menu Battle Preview

Standalone cumulative candidate over **regular 0.27.1 Runtime Repair**. Enable this package alone in place of 0.27.1; do not stack them. If the previous backdrop remains cached, restart the game after changing the enabled mod. The separate repair package remains available for comparison.
...
**Not observed yet:** actual menu framing, firing visuals, game performance, game-engine Lua execution and restart/cache behavior. Please confirm both fleets appear, escorts cross the foreground, weapon effects play and the menu stays responsive for a minute or two. The 0.27.1 crash repairs also still require their own runtime confirmation; the menu test does not establish save/reload or multiplayer stability.

No game launch, installation, enabled-mod change, save modification or publication was performed. Frozen 0.27.1 is retained unchanged.
