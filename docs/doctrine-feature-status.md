...
The agent has **not run the game**. New0.26 loading, before/after research on existing and new ships, capture/ally filters, simultaneous buffs, save/reload and multiplayer remain untested.0.26 is the cumulative correction candidate;0.25 is retained unchanged as rollback. Superseded0.22.0/0.23.1 files remain unchanged, but their station constructor access was wrong; use the corrected versions.
