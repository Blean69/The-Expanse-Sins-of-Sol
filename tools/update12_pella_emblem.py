...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'assets/derived/update12-a/pella';AUD=ROOT/'audit/update12-a/pella';MAT='expanse12_pella_free_navy';SRC=OUT/'emblem-sources/generated-charcoal-panel.png'
