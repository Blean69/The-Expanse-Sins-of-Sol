...
p=argparse.ArgumentParser();p.add_argument('--sdk',type=Path,required=True);p.add_argument('--wine',type=Path,required=True);args=p.parse_args();out=ROOT/'assets/derived/geometry03-b/hero';build=ROOT/'build/geometry03-b/hero';prefix=build/'proton-prefix';build.mkdir(parents=True,exist_ok=True)
