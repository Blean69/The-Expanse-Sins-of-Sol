...
u=edits[f'entities/{ID}.unit'];assert u['target_filter_unit_type']=='capital_ship'and u['build']['build_kind']=='cruiser'and u['build']['supply_cost']==300 and u['build']['build_group_id']=='capital_ship'
...
assert u['ai']['attack_target_type_groups']==rail['attack_target_type_groups']
