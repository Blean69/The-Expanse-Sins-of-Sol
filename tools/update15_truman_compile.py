...
PREFIX='expanse15_truman'
from common import read_mesh,Gltf
from polish_ui import write
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'assets/derived/update15-truman';BUILD=ROOT/'build/update15-truman';AUD=ROOT/'audit/update15-truman';MAIN=Path('/run/media/haker/NVME 2/expanse-mod');DONOR=Path('/run/media/haker/NVME 2/expanse-workers/tachi-one-pdc');SDK=Path('/run/media/haker/NVME 2/SteamLibrary/steamapps/common/Sins of a Solar Empire II - Mod Tools');wine=Path('/home/haker/.var/app/com.valvesoftware.Steam/.local/share/Steam/steamapps/common/Proton 10.0/files/bin/wine64');prefix=BUILD/'proton-prefix'
...
for kind in ['hull','rail_0','rail_1','pdc_base','pdc_barrel']:
