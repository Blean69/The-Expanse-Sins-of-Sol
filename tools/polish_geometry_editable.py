...
write(out/'expanse_polish_editable.gltf',g);check=Gltf(out/'expanse_polish_editable.gltf');assert len(check.world)==13;print('Editable13-part assembly prepared with hierarchy and original material/image references')
