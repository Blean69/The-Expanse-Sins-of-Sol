...
P=argparse.ArgumentParser();P.add_argument('--sdk',type=Path,required=True);P.add_argument('--wine',type=Path,required=True);args=P.parse_args();out=ROOT/'assets/derived/geometry03-b/hero';build=ROOT/'build/geometry03-b/hero';records={}
...
write(ROOT/'audit/geometry03-b/hero-winding-correction.json',records)
