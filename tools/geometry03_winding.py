...
P=argparse.ArgumentParser();P.add_argument('--sdk',type=Path,required=True);P.add_argument('--wine',type=Path,required=True);args=P.parse_args();out=ROOT/'assets/derived/geometry03-b/corvette';build=ROOT/'build/geometry03-b/corvette';records={}
...
write(ROOT/'audit/geometry03-b/winding-correction.json',records)
