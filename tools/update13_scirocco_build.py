...
R=Path(__file__).resolve().parents[1]; D=Path('/run/media/haker/NVME 2/expanse-workers/tachi-one-pdc');O=R/'assets/derived/update13-a';A=R/'audit/update13-a';B=R/'build/update13-a';P='expanse12_scirocco'
...
source=R/'assets/source/update13-a/charcoal-panel-tile.png';shutil.copyfile(source,tex/'expanse13_scirocco_panels_clr.png')
frames={}
