...
P=argparse.ArgumentParser();P.add_argument('--sdk',type=Path,required=True);P.add_argument('--wine',type=Path,required=True);args=P.parse_args();out=ROOT/'assets/derived/torpedo05-b';build=ROOT/'build/torpedo05-b';records={}
...
write(ROOT/'audit/torpedo05-b/winding-correction.json',records)
