...
def main():
    ...
    root=Path(__file__).resolve().parents[1];out=root/'build/update13-b/morrigan/ui';generated=out/'generated';source_dir=out/'source'
    ...
    audit=root/'audit/update13-b/morrigan';write(audit/'ui-validation.json',validation);write(audit/'ui-integration-spec.json',metadata);write(audit/'ui-render-recipe.json',recipe)
