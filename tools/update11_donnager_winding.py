...
P=argparse.ArgumentParser();P.add_argument('--sdk',type=Path,required=True);P.add_argument('--wine',type=Path,required=True);args=P.parse_args();out=ROOT/'assets/derived/update11-b';build=ROOT/'build/update11-b';records={}
...
write(ROOT/'audit/update11-b/winding-correction.json',records)
