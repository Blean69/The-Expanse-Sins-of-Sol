...
def main():
    ...
    root=Path(__file__).resolve().parents[1];out=args.output or root/'build/update13-a/ui';generated=out/'generated';source_dir=out/'source'
    ...
    audit=root/'audit/update13-a';write(audit/'ui-validation.json',validation);write(audit/'ui-integration-spec.json',metadata);write(audit/'ui-render-recipe.json',recipe)
