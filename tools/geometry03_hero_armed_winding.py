...
P=argparse.ArgumentParser();P.add_argument('--sdk',type=Path,required=True);P.add_argument('--wine',type=Path,required=True);args=P.parse_args();out=ROOT/'assets/derived/geometry03-b/hero-armed';build=ROOT/'build/geometry03-b/hero-armed';records={}
...
write(ROOT/'audit/geometry03-b/hero-armed-winding-correction.json',records)
